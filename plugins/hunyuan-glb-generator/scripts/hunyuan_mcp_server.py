    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "request_timeout_sec": {"type": "integer", "default": REQUEST_TIMEOUT_SEC},
                "reset": {"type": "boolean", "default": False},
                "host": {"type": "string", "default": DEFAULT_HOST},
                "port": {"type": "integer", "default": DEFAULT_PORT},
            },
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "stop_api_on_item_error": {"type": "boolean", "default": True},
                "host": {"type": "string", "default": DEFAULT_HOST},
                "port": {"type": "integer", "default": DEFAULT_PORT},
            },
            "required": ["items"],
    ...
    if name == "hunyuan_generate_from_image":
        ...
        return text_result(
            generate_from_image(
                ...
                request_timeout_sec=int(arguments.get("request_timeout_sec", REQUEST_TIMEOUT_SEC)),
                reset=bool(arguments.get("reset", False)),
                host=arguments.get("host", DEFAULT_HOST),
                port=int(arguments.get("port", DEFAULT_PORT)),
            )
    ...
    if name == "hunyuan_enqueue_image_batch":
        ...
        return text_result(
            enqueue_batch(
                ...
                request_timeout_sec=int(arguments.get("request_timeout_sec", REQUEST_TIMEOUT_SEC)),
                stop_api_on_item_error=bool(arguments.get("stop_api_on_item_error", True)),
                host=arguments.get("host", DEFAULT_HOST),
                port=int(arguments.get("port", DEFAULT_PORT)),
            )
        )
